...
namespace Pyramid2000_StraightPort
{
    public class Parser : IParser
    {
        ...
        private string[] _errors = new string[] { "WHAT?", "I DON'T KNOW THAT WORD.", "I DON'T UNDERSTAND.", "I DON'T KNOW WHAT YOU MEAN." };
        ...
        public ParsedCommand ParseInput(string command)
        {
            ...
            if (noun != null && verb == null)
            {
                foreach (var itemName in noun.Word.Items)
                {
                    ...
                    {
                        _printer.PrintLn("WHAT DO YOU WANT ME TO DO WITH THE " + noun.Original + "?");
                        return null;
                    }
                }
                _printer.PrintLn("I SEE NO " + noun.Original + " HERE.");
                return null;
            }
            ...
            {
                _printer.PrintLn(verb.Original + " WHAT?");
                _heldVerb = verb;
                return null;
            }
            ...
            else
            {
                ...
                if (nounItem == null)
                {
                    _printer.PrintLn("YOU AREN'T CARRYING IT.");
                    return null;
                }
            }
