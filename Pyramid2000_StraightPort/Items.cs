...
namespace Pyramid2000_StraightPort
{
    public class Items : IItems
    {
        ...
        {
            new Item() { Name = "#bridge_15", Location = "", Packable = false, Treasure = false, LongDescription = "A STONE BRIDGE NOW SPANS THE BOTTOMLESS PIT."},
            new Item() { Name = "#bridge_18", Location = "", Packable = false, Treasure = false, LongDescription = "A STONE BRIDGE NOW SPANS THE BOTTOMLESS PIT."},
            ...
            new Item() { Name = "#MACHINE", Location = "room_51", Packable = false, Treasure = false, LongDescription = @"THERE IS A MASSIVE VENDING MACHINE HERE. THE INSTRUCTIONS ON IT READ- ""DROP COINS HERE TO RECIEVE FRESH BATTERIES""." },
            new Item() { Name = "#PLANT_A", Location = "room_81", Packable = false, Treasure = false, LongDescription = @"THERE IS A TINY PLANT IN THE PIT, MURMURING ""WATER, WATER, ...""" },
            new Item() { Name = "#PLANT_B", Location = "", Packable = false, Treasure = false, LongDescription = @"THERE IS A TWELVE FOOT BEAN STALK STRETCHING UP OUT OF THE PIT, BELLOWING ""WATER... WATER...""" },
            new Item() { Name = "#PLANT_C", Location = "", Packable = false, Treasure =  false, LongDescription = "THERE IS A GIGANTIC BEAN STALK STRETCHING ALL THE WAY UP TO THE HOLE." },
            new Item() { Name = "#-10-", Location = "", Packable = false, Treasure = false },
            new Item() { Name = "#SERPENT", Location = "room_16", Packable = false, Treasure = false, LongDescription = "A HUGE GREEN FIERCE SERPENT BARS THE WAY!" },
            new Item() { Name = "#-12-", Location = "", Packable = false, Treasure = false },
            new Item() { Name = "#-13-", Location = "", Packable = false, Treasure = false },
            new Item() { Name = "#LAMP_off", Location = "room_2", Packable = true, Treasure = false, ShortDescription = "BRASS LANTERN", LongDescription = "THERE IS A SHINY BRASS LAMP NEARBY." },
            new Item() { Name = "#LAMP_on", Location = "", Packable = true, Treasure = false, ShortDescription = "BRASS LANTERN", LongDescription = "THERE IS A LAMP SHINING NEARBY.", Time = 310 },
            new Item() { Name = "#BOX", Location = "room_8", Packable = true, Treasure = false, ShortDescription = "STATUE BOX", LongDescription = "THERE IS A SMALL STATUE BOX DISCARDED NEARBY." },
